...
impl EngineVersion {
    ...
    pub fn is_enabled(&self, feature: ProtocolFeature) -> bool {
        match feature {
            ...
            ProtocolFeature::ReadDataFromShardZero
            | ProtocolFeature::UserProfileToken
            | ProtocolFeature::RevalidateMessage => self >= &EngineVersion::V10,
        }
    }
    ...
    pub fn protocol_version(&self) -> u32 {
        match self {
            ...
            EngineVersion::V8 => 5,
            EngineVersion::V9 => 6,
            EngineVersion::V10 => LATEST_PROTOCOL_VERSION,
        }
    }
...
mod version_test {
    ...
    #[test]
    fn test_latest() {
        assert_eq!(EngineVersion::latest(), EngineVersion::V10);
        assert_eq!(
    ...
    fn test_next_version_timestamp_for() {
        ...
        let time = FarcasterTime::from_unix_seconds(1758733200);
        assert_eq!(
            EngineVersion::next_version_timestamp_for(&time, FarcasterNetwork::Mainnet),
            None
        );
