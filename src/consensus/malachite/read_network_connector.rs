...
pub struct MalachiteReadNetworkConnector<Codec> {
    pub codec: Codec,
}

pub struct ReadNetworkConnectorState {
...
#[async_trait]
impl<Codec> Actor for MalachiteReadNetworkConnector<Codec>
where
    Codec: ConsensusCodec<SnapchainValidatorContext> + SyncCodec<SnapchainValidatorContext>,
{
    type Msg = Msg<SnapchainValidatorContext>;
    type State = ReadNetworkConnectorState;
    type Arguments = ReadNetworkConnectorArgs;
